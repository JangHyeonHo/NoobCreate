...
<head>
   ...
   //답글 쓰기 버튼을 클릭했을때 호출되는 함수
   	function fn_reply_form(url, parentNO) {
   		
	   var form = document.createElement("form");
	   form.setAttribute("method", "post");//매개변수로 전달 받은 요청주소를 <form>태그의 action 속성에 주소 값으로 설정함.
	   form.setAttribute("action", url); //url 변수 요청값
		...
		<tr>
		  ...
		  <tr  id="tr_btn">
		   <td colspan=2 align=center>
			    ...
			    <!-- 답글쓰기를 클릭하면 fn_reply_form() 함수를 호출하면서 글번호와 답글요청주소를 함께 전달함 -->
