...
//DAO 클래스의 역활 : DB에 연결하여 DB작업 하는 클래스 입니다.
...
public class MemberDAO {
	...
	public MemberVO findMember(String id) {
		...
		try{
			//커넥션풀로 부터 커넥션 얻기
			con = ds.getConnection();
			//SQL 문 만들고 SQL 문을 실행할 preparedStatement 객체 얻기
	...
	//매개변수로 전달받은 MemberVO객체를 이용하여 회원정보 수정Update
	...
	//매개변수로 전달된 삭제할 id를 이용해 t_member테이블에 저장된 회원 삭제
